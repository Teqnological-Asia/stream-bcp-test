          ...
          <div className="p-modal_window p-modal_window_shomen">
            <div className="p-modal_window_contents">
              <div className="p-modal_window_msg_shomen">
                <p>■契約締結前書面の確認<br/>いつも弊社をご利用いただきありがとうございます。契約締結前交付書面の再交付をいたします。金融商品取引法に基づき、お客様に各種金融商品取引の仕組み・リスク等を再度ご確認していただくため、弊社では年に一度、もしくは改定時に契約締結前交付書面の再交付をさせていただきます。<br/>お手数ですが、下記URLを閲覧いただき、「確認・同意」ボタンを押してください。（「確認・同意」頂けない場合には、ログインいただけませんのでご注意ください。）</p>
