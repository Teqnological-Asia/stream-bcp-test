    ...
    if (!checkAll) {
      ...
      this.types.forEach((type) => {
        if (this.state[type] === true) {
          if (type === 'margin') {
            typeParams.push('margin_open', 'margin_close', 'margin_swap', 'dividend_adjustment')
          } else {
          ...
          <div className="p-section_search">
            <div className="p-section_search_item">
              ...
              <div className="p-section_search_item_body">
                ...
                <label className="p-form-object_label">
                  <input type="checkbox" checked={other} name="other" onChange={this.handleCheckType}/>その他
                </label>
              </div>
            </div>
            <div className="p-section_search_item">
